        ...
        @if($question->question_type === "text")
                <div class="col-md-8 form-group">
                    <label class = "mb-4" for="question_{{$question->id}}">{{__("Question")}} {{$question->question_order}}
                        ...
                        <a data-url = "{{route("questions.edit")}}" data-id = "{{$question->id}}" id = "editButton"  data-value = "{{$question->question_text}}" class = "btn btn-primary btn-sm edit-button">
                 ...
                 @foreach($question->options as $option)
                    <div class="form-check m-3 ">
                        ...
                        <label class="form-check-label" for="option_text_{{$option->id}}">{{$option->option_text}}
                            ...
                            <a data-url = "{{route("options.edit")}}" data-id = "{{$option->id}}" id = "editButton"  data-value = "{{$option->option_text}}" class = "btn btn-primary btn-sm edit-button">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        </label>
                    </div>
